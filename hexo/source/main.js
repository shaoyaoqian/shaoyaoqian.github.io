...
loadScript("https://cdn.staticfile.org/Chart.js/4.3.0/chart.umd.min.js").then(() => {
  ...
  const labels = ['8月15日', '8月18日','8月19日','8月20日','8月20日','8月15日','9月30日', '10月14日', '11月9日', '11月11日', '12月7日', '12月14日', '12月21日', '2024年1月6日','1月18日', '2月21日', '2月25日',  '3月16日', '4月18日'];
  data_e_money = [121.72,    127.49,  129.17,   140.40,  241.17,   241.17,   241.17, 241.17,     361.17,   370.99,     383,      433,        533,       533,          533,      533,      533,        640.5,    640.5];
  data_e_consume = [160.4,   168.6,   171.1,    187.1,   188.2,    268.2,    268.2,  315.9,      381.7,    425.8,      475.5,    513.7,      565.9,     614.5,        666.6,    736.2,    773.4,      831.6,    896.2];
  data_oil_money = [200,     200,     200,      200,     200,      200,      200,    200,        200,      200,        200,      200,        300,       300,          300,      400,      400,        400,      400];
  data_oil_consume = [11.4,  11.5,    11.5,     11.8,    11.8,     12.4,     12.4,   12.7,       14.7,     17.1,       18.9,     19.3,       19.8,      21.9,         22.5,     25.9,     30.5,       31,       31.5];
  data_distance = [1115,     1171,    1183,     1308,    1316,     1849,     2013,   2121,       2583,     2844,       3159,     3243,       3425,      3656,         3863,     4113,     4346,       4765,     5202];
