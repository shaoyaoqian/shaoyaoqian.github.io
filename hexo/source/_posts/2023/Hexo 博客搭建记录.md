...
最近参考了 [班班](https://pinlyu.com/posts/30/) 的博客重新设计了自己的博客，打算写个总结。博客的内容比形式重要，本站的风格偏向于简洁。

<!--more-->

## 1. 域名解析

考虑到访问速度和运营成本，本站使用了 **GitHub、Vercel、Cloudflare、又拍云**四家公司提供的服务。GitHub生成和存储网站的静态文件，Vercel提供网站托管服务，Cloudflare提供域名解析服务，又拍云提供CDN服务。
